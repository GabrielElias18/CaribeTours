    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-content">
          <div className="footer-column">
            ...
            <p className="footer-description">
              ...
              Experiencias auténticas, servicio de calidad y precios justos.
            </p>
            <div className="social-links">
              <a
                href="https://instagram.com/caribetours"
                target="_blank"
              ...
              <a
                href="https://facebook.com/caribetours"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link"
                aria-label="Facebook"
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="#paquetes" onClick={() => scrollToSection('paquetes')}>
                  Paquetes
                </a>
              </li>
              <li>
                <a href="#resenas" onClick={() => scrollToSection('resenas')}>
                  Reseñas
                </a>
              </li>
              <li>
        ...
        <div className="footer-bottom">
          <p>© {currentYear} Caribe Tours. Todos los derechos reservados.</p>
          <p>Hecho con ❤️ en Cartagena, Colombia</p>
        </div>
      </div>
    </footer>
  );
